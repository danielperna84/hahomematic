...
HM_VIRTUAL_REMOTE_HM_TYPES = "HM-RCV-50"
HM_VIRTUAL_REMOTE_HMW_TYPES = "HMW-RCV-50"
HM_VIRTUAL_REMOTE_HMIP_TYPES = "HmIP-RCV-50"
HM_VIRTUAL_REMOTE_TYPES = [
    HM_VIRTUAL_REMOTE_HM_TYPES,
    HM_VIRTUAL_REMOTE_HMW_TYPES,
    HM_VIRTUAL_REMOTE_HMIP_TYPES,
]
