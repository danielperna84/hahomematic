...
HH_EVENT_HUB_CREATED: Final = "hubEntityCreated"
...
CHANNEL_OPERATION_MODE_VISIBILITY: Final[dict[str, tuple[str, ...]]] = {
...
DEFAULT_CONNECTION_CHECKER_INTERVAL: Final = 15
# wait with reconnect after a first ping was successful
DEFAULT_RECONNECT_WAIT: Final = 120
...
HM_VIRTUAL_REMOTE_HMW_ADDRESS: Final = "HMW-RCV-50"  # unknown
