...
from hahomematic import device as hmd
...
from hahomematic.entity_support import ExtendedConfig, value_property
from hahomematic.generic_platforms import entity as hmge
...
class CustomEntity(BaseEntity):
    ...
    def __init__(
        ...
        self._device_enum: Final[EntityDefinition] = device_enum
