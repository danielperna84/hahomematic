    ...
    ED_DEVICE_DEFINITIONS: {
        EntityDefinition.IP_COVER: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    Field.COMBINED_PARAMETER: "COMBINED_PARAMETER",
                    Field.LEVEL: "LEVEL",
                    Field.LEVEL_2: "LEVEL_2",
                    Field.STOP: "STOP",
                },
                ED_FIELDS: {
                    0: {
                        Field.DIRECTION: "ACTIVITY_STATE",
                        Field.CHANNEL_LEVEL: "LEVEL",
                        Field.CHANNEL_LEVEL_2: "LEVEL_2",
                        Field.CHANNEL_OPERATION_MODE: "CHANNEL_OPERATION_MODE",
                    },
                },
            },
        },
        EntityDefinition.IP_DIMMER: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    Field.LEVEL: "LEVEL",
                    Field.ON_TIME_VALUE: "ON_TIME",
                    Field.RAMP_TIME_VALUE: "RAMP_TIME",
                },
                ED_VISIBLE_FIELDS: {
                    0: {
                        Field.CHANNEL_LEVEL: "LEVEL",
        ...
        EntityDefinition.IP_GARAGE: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    Field.DOOR_COMMAND: "DOOR_COMMAND",
                    Field.SECTION: "SECTION",
                },
                ED_VISIBLE_REPEATABLE_FIELDS: {
                    Field.DOOR_STATE: "DOOR_STATE",
                },
            },
        ...
        EntityDefinition.IP_FIXED_COLOR_LIGHT: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    Field.COLOR: "COLOR",
                    Field.LEVEL: "LEVEL",
                    Field.ON_TIME_UNIT: "DURATION_UNIT",
                    Field.ON_TIME_VALUE: "DURATION_VALUE",
                    Field.RAMP_TIME_UNIT: "RAMP_TIME_UNIT",
                    Field.RAMP_TIME_VALUE: "RAMP_TIME_VALUE",
                },
                ED_VISIBLE_FIELDS: {
                    0: {
                        Field.CHANNEL_COLOR: "COLOR",
                        Field.CHANNEL_LEVEL: "LEVEL",
                    },
                },
            },
        ...
        EntityDefinition.IP_SIMPLE_FIXED_COLOR_LIGHT_WIRED: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    ...
                    Field.RAMP_TIME_UNIT: "RAMP_TIME_UNIT",
                    Field.RAMP_TIME_VALUE: "RAMP_TIME_VALUE",
                    Field.COLOR_BEHAVIOUR: "COLOR_BEHAVIOUR",
                },
            },
        },
        ...
        EntityDefinition.IP_RGBW_LIGHT: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    Field.DIRECTION: "ACTIVITY_STATE",
                    Field.COLOR_TEMPERATURE: "COLOR_TEMPERATURE",
                    Field.EFFECT: "EFFECT",
                    Field.HUE: "HUE",
                    Field.LEVEL: "LEVEL",
                    Field.RAMP_TIME_TO_OFF_UNIT: "RAMP_TIME_TO_OFF_UNIT",
                    Field.RAMP_TIME_TO_OFF_VALUE: "RAMP_TIME_TO_OFF_VALUE",
                    Field.RAMP_TIME_UNIT: "RAMP_TIME_UNIT",
                    Field.RAMP_TIME_VALUE: "RAMP_TIME_VALUE",
                ...
                ED_FIELDS: {
                    0: {
                        Field.DEVICE_OPERATION_MODE: "DEVICE_OPERATION_MODE",
                    },
                },
            },
        },
        ...
        EntityDefinition.IP_LOCK: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    ...
                    Field.LOCK_TARGET_LEVEL: "LOCK_TARGET_LEVEL",
                },
                ED_FIELDS: {
                    0: {
                        Field.ERROR: "ERROR_JAMMED",
                    },
                },
            },
        },
        EntityDefinition.IP_SIREN: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    Field.ACOUSTIC_ALARM_ACTIVE: "ACOUSTIC_ALARM_ACTIVE",
                    Field.OPTICAL_ALARM_ACTIVE: "OPTICAL_ALARM_ACTIVE",
                    Field.ACOUSTIC_ALARM_SELECTION: "ACOUSTIC_ALARM_SELECTION",
                    Field.OPTICAL_ALARM_SELECTION: "OPTICAL_ALARM_SELECTION",
                    Field.DURATION: "DURATION_VALUE",
                    Field.DURATION_UNIT: "DURATION_UNIT",
                },
            },
        },
        EntityDefinition.IP_SIREN_SMOKE: {
            ED_DEVICE_GROUP: {
                ED_PRIMARY_CHANNEL: 1,
                ED_REPEATABLE_FIELDS: {
                    Field.SMOKE_DETECTOR_COMMAND: "SMOKE_DETECTOR_COMMAND",
                },
                ED_VISIBLE_REPEATABLE_FIELDS: {
                    Field.SMOKE_DETECTOR_ALARM_STATUS: "SMOKE_DETECTOR_ALARM_STATUS",
                },
            },
        },
        EntityDefinition.IP_THERMOSTAT: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    ...
                    Field.BOOST_MODE: "BOOST_MODE",
                    Field.CONTROL_MODE: "CONTROL_MODE",
                    Field.HEATING_COOLING: "HEATING_COOLING",
                    Field.PARTY_MODE: "PARTY_MODE",
                    Field.SETPOINT: "SET_POINT_TEMPERATURE",
                    Field.SET_POINT_MODE: "SET_POINT_MODE",
                    Field.TEMPERATURE_MAXIMUM: "TEMPERATURE_MAXIMUM",
                    Field.TEMPERATURE_MINIMUM: "TEMPERATURE_MINIMUM",
                },
                ED_VISIBLE_REPEATABLE_FIELDS: {
                    Field.HUMIDITY: "HUMIDITY",
                    Field.TEMPERATURE: "ACTUAL_TEMPERATURE",
                },
                ED_VISIBLE_FIELDS: {
                    0: {
                        Field.LEVEL: "LEVEL",
        ...
        EntityDefinition.RF_COVER: {
            ED_DEVICE_GROUP: {
                ...
                ED_REPEATABLE_FIELDS: {
                    ...
                    Field.LEVEL: "LEVEL",
                    Field.LEVEL_2: "LEVEL_SLATS",
                    Field.LEVEL_COMBINED: "LEVEL_COMBINED",
                    Field.STOP: "STOP",
                },
            },
        },
        ...
        EntityDefinition.RF_THERMOSTAT: {
            ED_DEVICE_GROUP: {
                ED_PRIMARY_CHANNEL: 0,
                ED_REPEATABLE_FIELDS: {
                    Field.AUTO_MODE: "AUTO_MODE",
                    Field.BOOST_MODE: "BOOST_MODE",
                    Field.COMFORT_MODE: "COMFORT_MODE",
                    Field.CONTROL_MODE: "CONTROL_MODE",
                    Field.LOWERING_MODE: "LOWERING_MODE",
                    Field.MANU_MODE: "MANU_MODE",
                    Field.SETPOINT: "SET_TEMPERATURE",
                    Field.TEMPERATURE_MAXIMUM: "TEMPERATURE_MAXIMUM",
                    Field.TEMPERATURE_MINIMUM: "TEMPERATURE_MINIMUM",
                },
                ED_VISIBLE_REPEATABLE_FIELDS: {
                    Field.HUMIDITY: "ACTUAL_HUMIDITY",
                    Field.TEMPERATURE: "ACTUAL_TEMPERATURE",
                },
                ED_VISIBLE_FIELDS: {
                    0: {
                        Field.VALVE_STATE: "VALVE_STATE",
                    },
                },
            },
        },
